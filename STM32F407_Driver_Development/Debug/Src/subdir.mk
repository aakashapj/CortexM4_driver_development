...
C_SRCS += \
../Src/001_Blinking_LED.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/001_Blinking_LED.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/001_Blinking_LED.d \
./Src/syscalls.d \
./Src/sysmem.d 


# Each subdirectory must supply rules for building sources it contributes
Src/001_Blinking_LED.o: ../Src/001_Blinking_LED.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32 -DSTM32F407G_DISC1 -DSTM32F4 -DSTM32F407VGTx -DDEBUG -c -I../Inc -I"F:/Embedded Pojects/CortexM4_driver_development/STM32F407_Driver_Development/driver/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/001_Blinking_LED.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
